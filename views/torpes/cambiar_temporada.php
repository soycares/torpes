                ...
                <div id="contact" class="container">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            ?>
                            <?=form_open('torpes/inicio/cambio_temporada','method="post"')?>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <select  id="idTemporada" name="idTemporada" class="form-control">
                                              <?php foreach($temporadas->result() as $fila) {
                                                echo '<option value="'.$fila->idTemporada.'">'.$fila->descripcion."</option>";
                                              }
                                              ?>
                                            </select>
                                        </div>
