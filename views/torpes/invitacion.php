...
<?php } ?>
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            $pag 
                            ?>
                            <?=form_open('torpes/inicio/crear','method="post"')?>
								<input type="hidden" name="idTemporada" id="idTemporada" value="<?=$idTemporada?>">
                                <div class="row">
									<div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text"  class="form-control" readonly value="<?=$descripcion?>" name="descripcion" id="descripcion">
                                        </div>
                                    </div>
									<div class="col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Código del usuario">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="email" placeholder="Email" id="email" name="email" class="form-control" value="<?=$email?>" readonly>
                                        </div>
                                    </div>
